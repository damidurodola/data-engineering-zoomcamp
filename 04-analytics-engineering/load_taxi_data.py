...
BUCKET_NAME = "bigquery-zoomcamp-dami-demo"

# If you authenticated through the GCP SDK you can comment out these two lines
CREDENTIALS_FILE = "/workspaces/data-engineering-zoomcamp/03-data-warehouse/gcs.json"
...
if __name__ == "__main__":
    ...
    # with ThreadPoolExecutor(max_workers=4) as executor:
    #     parquet_paths = list(executor.map(convert_csv_to_parquet, filter(None, file_paths)))
